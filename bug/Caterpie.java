...
public class Caterpie{
	...
	public Caterpie(int growthRate, int evolutionThreshold){
	...
	public void lowerEnemyStatus(){
		System.out.println("Calling the lowerEnemyStatus of Caterpie");
	}
	
	public void absorbHealth(){
		System.out.println("Calling the absorbHealth of Caterpie");
	}
